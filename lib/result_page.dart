        ...
        child: Column(
          ...
          children: [
            ...
            GestureDetector(
              ...
              onTapDown: (details) => debugPrint('TTS: onTapDown at ${details.globalPosition}'),
              onTap: () {
                final text = example['eng'] as String;
                debugPrint('TTS: Example tapped — speaking: $text');
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(
                      'Speaking: ${text.length > 60 ? '${text.substring(0, 60)}...' : text}',
                    ),
              ...
              child: Row(
                ...
                children: [
                  ...
                  IconButton(
                    onPressed: () {
                      final text = example['eng'] as String;
                      debugPrint('TTS: Volume pressed — speaking: $text');
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'Speaking: ${text.length > 60 ? '${text.substring(0, 60)}...' : text}',
...
// `PosBadge` moved to `lib/search/pos_badge.dart` to avoid duplication.
